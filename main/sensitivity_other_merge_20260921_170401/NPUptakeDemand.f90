...
<<<<<<< /home/user/fangwei/FangxiuWan-TECO-CNP-Sv1.0-edff198/TECO-CNP Sv1.0 20250316/main/NPUptakeDemand.f90
      kPmin = 3
      kPmin_low = 0.01 
||||||| /home/user/fangwei/TECO_sensitivity_server/baseline_main/NPUptakeDemand.f90
      kPmin = 3
      kPmin_low = 0.01 
=======
      kPmin = 3 * sens_kpmin
      kPmin_low = 0.01 * sens_kpmin_low
>>>>>>> /home/user/fangwei/TECO_sensitivity_server/patched_main/NPUptakeDemand.f90
